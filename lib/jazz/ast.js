...
Suite.prototype.toString = function() {
    return "Suite(" + this.body.map(function(stmt) {
...
Define.prototype.toString = function() {
    return "Define(" + this.ident.toString() + ", " + this.expr.toString() + ")";
};
...
Hash.prototype.toString = function() {
    return "Hash(" + this.body.map(function(kv) {
        return kv[0].toString() + ":" + kv[1].toString();
    }).join(", ") + ")";
};
