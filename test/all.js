...
var testCases = [
  ...
  ["{define test 'test'}{test}",
    [{}, "test"],
    [{tmp: "tmp"}, "test"]],
  ["{define test true}{if test}success{else}fail{end}",
    [{}, "success"]],
  ["{define test tmp}{test}",
    [{tmp: 0}, "0"],
    [{tmp: "str"}, "str"]],
  ["{test}{define test tmp}{test}",
    [{test: 1, tmp: 0}, "10"],
    [{test: "str2", tmp: "str"}, "str2str"]],
  ["{define test tmp}{test[1]}",
    [{tmp: [3,2,1]}, "2"]],
  ["{define test @tmp()}{test[1]}",
    [{tmp: function(){return [3,2,1]}}, "2"]],
  ["{define test muffin.numberOfBites}{test}",
    [{muffin: new Muffin(5)}, "5"]],
  ["{define test @tmp.execute()}{test}",
    [{tmp: {item: 0, execute: function(){return ++this.item}}}, "1"]],
  ["{array[0]}",
    [{array : ["one"]}, "one"]],
  ["{obj.array[0]}",
    [{obj : {array : ["one"]}}, "one"]],
